...
public interface CandidatApi {
	...
	public	CandidatDto save(@RequestBody CandidatDto dto );
	...
	public CandidatDto findById(@ApiParam(value="Accepte la valeur IdCandidat")  @PathVariable("idCondidat") Long id) ;
	 ...
	 public void  delete(@RequestParam("idCandidat") Long id) ;
