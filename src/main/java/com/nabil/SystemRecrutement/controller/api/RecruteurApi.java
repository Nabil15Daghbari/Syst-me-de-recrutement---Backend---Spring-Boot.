...
public interface RecruteurApi {
	...
	recruteurDto save(@RequestBody recruteurDto dto);
	 ...
	 @ApiOperation(value="rechercher les recruteurs dans l BDD " , notes="Cette methode permet de chercher les recruteurs  " , response = recruteurDto.class)
		@ApiResponses(value= {
